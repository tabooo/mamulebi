...
<script>
function reportsalesbugalteria(){
				$(function() {
					var fromyear = $('#fromyear').val();
					var frommon = $('#frommon').val();
					var fromday = $('#fromday').val();
					//var today = $('#today').val();
					                    $.post('php.php',{dos:"reportsalesbugalteria",fromyear:fromyear,frommon:frommon,fromday:fromday}, function(data){
...
<input value="ძებნა" type="button" onClick="reportsalesbugalteria()">
<input value="კონვერტაცია Excel-ში" type="submit">
