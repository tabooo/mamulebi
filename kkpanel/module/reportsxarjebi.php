...
function reportsales(){
				$(function() {
					...
					var datarange = $('#daterange').val();
					                    $.post('php.php',{dos:"reportsxarjebi",product:product,datarange:datarange}, function(data){
...
<h3>ხარჯების რეპორტები </h3>
<script type="text/javascript">document.title = 'ხარჯების რეპორტები';</script>
<table><tr>
<td width="200">
აირჩიეთ პერიოდი:
</td>
