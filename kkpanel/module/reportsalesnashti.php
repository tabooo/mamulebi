...
<script>
function reportsalesnashti(){
	$(function() {
		var adgili=$('#adgili').val();
		var datarange = $('#daterange').val();
		$.post('php.php',{dos:"reportsalesnashti",adgili:adgili,datarange:datarange}, function(data){
...
<?php
$pr=mysql_query("select * from adgili order by id asc");
...
<input value="ძებნა" type="button" onClick="reportsalesnashti()"><div style="float:right"><a href="?cat=reports"><input type="button" value="<-- უკან დაბრუნება" /></a></div>
<div id="show_results">
</div>
